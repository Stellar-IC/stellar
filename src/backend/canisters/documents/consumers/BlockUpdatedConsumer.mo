...
module BlockUpdatedConsumer {
    ...
    public func execute(event : Types.BlockUpdatedEvent, state : State.State) : Result.Result<Types.Block, { #blockNotFound; #insufficientCycles; #inputTooLong; #invalidBlockType; #failedToUpdate; #anonymousUser }> {
