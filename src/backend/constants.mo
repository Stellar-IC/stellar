module Constants {
    ...
    public let USER__COMPUTE_ALLOCATION = 5; // 5% of maximum compute power that a single canister can allocate
    public let USER__FREEZING_THRESHOLD = 2592000; // 30 days
    public let USER__INITIAL_CYCLES_BALANCE = USER__CAPACITY;
    public let USER__MEMORY_ALLOCATION = 5_000_000; // 5MB
    ...
    public let WORKSPACE__COMPUTE_ALLOCATION = 5; // 5% of maximum compute power that a single canister can allocate
