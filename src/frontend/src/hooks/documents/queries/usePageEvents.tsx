...
export const usePageEvents = () => {
  const [events, setEvents] = useState<Record<string, SerializedSaveEventUpdateInput[]>>({});

  const addEvent = useCallback((pageExternalId: string, event: SaveEventUpdateInput) => {
    setEvents((prev) => {
