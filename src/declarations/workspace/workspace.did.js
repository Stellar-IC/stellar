export const idlFactory = ({ IDL }) => {
  ...
  const BlockPropertyCheckedUpdatedEvent = IDL.Record({
  ...
  const BlockPropertyTitleUpdatedEvent = IDL.Record({
    data: IDL.Record({
      transaction: IDL.Vec(TreeEvent),
      blockExternalId: UUID,
    }),
  ...
  const Workspace = IDL.Service({
    ...
    deletePage: IDL.Func([DeletePageUpdateInput], [DeletePageUpdateOutput], []),
