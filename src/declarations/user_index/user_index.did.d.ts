...
export type CheckUsernameResult = { ok: null } | { err: CheckUsernameError };
...
export type RegisterUserError =
  | { canisterNotFoundForRegisteredUser: null }
  | { userNotFound: null }
  | { anonymousUser: null }
...
export type Result_1 = { ok: Principal } | { err: { userNotFound: null } };
export type Result_2 = { ok: null } | { err: { unauthorized: null } };
