...
export type Result_4 =
  ...
  | { err: { unauthorized: null } };
export type Result_5 = { ok: UserProfile } | { err: { unauthorized: null } };
...
export interface User {
  ...
  >;
  personalWorkspace: ActorMethod<[], Result_6>;
  profile: ActorMethod<[], Result_5>;
  publicProfile: ActorMethod<[], Result_4>;
