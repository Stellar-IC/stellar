...
export interface AddBlockUpdateOutputResult { 'id' : PrimaryKey }
...
export interface Edge { 'node' : ShareablePage }
...
export type Result = { 'ok' : ShareablePage } |
...
export type SaveEventUpdateOutput = { 'ok' : SaveEventUpdateOutputResult } |
  { 'err' : SaveEventUpdateOutputError };
export type SaveEventUpdateOutputError = { 'anonymousUser' : null } |
  { 'insufficientCycles' : null };
